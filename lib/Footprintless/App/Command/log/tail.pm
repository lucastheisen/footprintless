...
package Footprintless::App::Command::log::tail;

# ABSTRACT: output the last part of a file
# PODNAME: Footprintless::App::Command::log::tail
...
sub usage_desc { 
    return "fpl log LOG_COORD tail %o";
}
